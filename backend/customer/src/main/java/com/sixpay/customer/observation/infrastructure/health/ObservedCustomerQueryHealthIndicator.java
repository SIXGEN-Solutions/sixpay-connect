...
public final class ObservedCustomerQueryHealthIndicator
    ...
    private static final double DEGRADED_FAILURE_RATE =
            0.05D;

    private static final double DOWN_FAILURE_RATE =
            0.20D;
    ...
    public Health health() {
        try {
            ...
            Instant oldestProjectionAt =
                    oldestProjectionAt();

            Duration oldestProjectionAge =
                    nonNegativeAge(
                            oldestProjectionAt
                    );
    ...
    private Duration nonNegativeAge(
            Instant value
    ) {
        if (value == null) {
