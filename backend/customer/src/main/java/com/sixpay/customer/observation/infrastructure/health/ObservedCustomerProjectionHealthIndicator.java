...
public final class ObservedCustomerProjectionHealthIndicator
    ...
    private static final Duration DEGRADED_LAG =
            Duration.ofMinutes(5);

    private static final Duration DOWN_LAG =
    ...
    private Duration nonNegativeLag(
            Instant lastProcessedEventAt
    ) {
        if (lastProcessedEventAt == null) {
