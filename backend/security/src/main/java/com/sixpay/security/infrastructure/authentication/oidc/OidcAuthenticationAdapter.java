...
/**
 * Provider-neutral OIDC adapter.
 *
 * <p>The IdP proves identity only. No JWT role, scope, realm role or provider
 * group is converted to a SIXPAY business authority here.</p>
 */
public final class OidcAuthenticationAdapter
    ...
    private String requiredClaim(
        ...
        String value =
                jwt.getClaimAsString(claimName);
