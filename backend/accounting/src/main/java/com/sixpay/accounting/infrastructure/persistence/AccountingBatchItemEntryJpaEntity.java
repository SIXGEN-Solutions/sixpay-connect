...
public class AccountingBatchItemEntryJpaEntity {
    ...
    private AccountingBatchItemJpaEntity batchItem;
    ...
    static AccountingBatchItemEntryJpaEntity create(AccountingBatchItemJpaEntity batchItem, AccountingBatchItem.FrozenEntry entry) {
        var e = new AccountingBatchItemEntryJpaEntity();
        e.id = UUID.randomUUID();
        e.batchItem = batchItem;
    ...
    AccountingBatchItem.FrozenEntry toDomain() {
        return new AccountingBatchItem.FrozenEntry(
