...
class PaymentIntegrationMapperTest {
    ...
    void mapsOutboxEntityToTransportNeutralEnvelope() {
        ...
        Instant occurredAt = Instant.parse("2026-08-01T16:00:00Z");
        ...
        var envelope = new PaymentIntegrationMapper().toEnvelope(entity);

        assertThat(envelope.eventId()).isEqualTo(eventId);
        assertThat(envelope.eventType()).isEqualTo("PaymentReceived");
        assertThat(envelope.schemaVersion()).isOne();
