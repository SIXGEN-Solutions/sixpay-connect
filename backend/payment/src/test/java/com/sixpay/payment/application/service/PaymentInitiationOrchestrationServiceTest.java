...
class PaymentInitiationOrchestrationServiceTest {
    ...
    private static InitiatePaymentCommand command(){ return new InitiatePaymentCommand(PaymentSource.of("TRESOR_PAY"),ExternalSubscriptionReference.of("TRESOR_PAY:TP_APP_001"),PartnerIdentity.from("11111111-2222-3333-4444-555555555555"),"TP_APP_001","AVI-2025-00045678",new BigDecimal("600000"),"XAF","10005-00001-12345678901-12","Société ABC SARL",ClaimType.AVI,"100200300",NOW,List.of(new PaymentBeneficiaryCommand("10005-00001-TRESDGI-97",new BigDecimal("600000"))),"https://tresorpay.cm/callback","IDEMPOTENCY-00000001",CorrelationId.of("11111111-1111-1111-1111-111111111111")); }
}
