      ...
      @if (overview(); as data) {
        ...
        <div class="sp-grid">
          <sp-card
            ...
            subtitle="Identités, méthodes et autorisations"
          >
            <p>
              Administrer Local, SSO, linking OIDC,
              statut utilisateur et audit.
            </p>
            <a spCardActions routerLink="users">
              Ouvrir
            </a>
          </sp-card>
          ...
          <sp-card
            ...
            subtitle="Configuration applicative"
          >
            <p>
              Configuration opérationnelle réellement
              exposée par SIXPAY.
            </p>
            <a spCardActions routerLink="settings">
              Ouvrir
            </a>
          </sp-card>
          ...
          <sp-card
            title="Intégrations"
            subtitle="État des dépendances"
          >
            <p>
              {{ degradedCount() }} intégration(s)
              non disponible(s) ou dégradée(s) sur
              {{ data.integrations.length }}.
            </p>
            <a spCardActions routerLink="integrations">
              Ouvrir
            </a>
          </sp-card>
        </div>
...
export class AdministrationPageComponent {
  ...
  protected readonly overview =
    signal<AdministrationOverview | null>(null);
