...
export class CustomerManagementService {
  ...
  search(criteria: CustomerSearchCriteria): Observable<CustomerPage> {
  ...
  bankingPreview(request: BankingCustomerPreviewRequest): Observable<BankingCustomerPreview> {
  ...
  update(customerId: string, request: UpdateCustomerRequest): Observable<CustomerMaster> {
  ...
  addAccount(customerId: string, request: AddBankAccountRequest): Observable<CustomerMaster> {
    return this.api.addAccount(customerId, request).pipe(map(mapCustomerMaster));
  }

  makeDefaultAccount(customerId: string, accountId: string): Observable<CustomerMaster> {
    return this.api.makeDefaultAccount(customerId, accountId).pipe(map(mapCustomerMaster));
  }

  removeAccount(customerId: string, accountId: string): Observable<CustomerMaster> {
    return this.api.removeAccount(customerId, accountId).pipe(map(mapCustomerMaster));
  }
  ...
  createSubscription(request: CreateSubscriptionRequest): Observable<CustomerSubscription> {
    return this.api.createSubscription(request).pipe(map(mapCustomerSubscription));
  }

  activateSubscription(subscriptionId: string): Observable<CustomerSubscription> {
    return this.api.activateSubscription(subscriptionId).pipe(map(mapCustomerSubscription));
  }
  ...
  suspendSubscription(
    ...
    return this.api.suspendSubscription(subscriptionId, request).pipe(map(mapCustomerSubscription));
  }

  closeSubscription(subscriptionId: string, request: ReasonRequest): Observable<void> {
    return this.api.closeSubscription(subscriptionId, request);
  }
}
