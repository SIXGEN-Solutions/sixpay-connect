    ...
    children: [
      {
        ...
        loadComponent: () =>
          import(
            './features/dashboard/components/dashboard-page.component'
          ).then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './features/dashboard/components/design-system-catalog.component'
          ).then(
