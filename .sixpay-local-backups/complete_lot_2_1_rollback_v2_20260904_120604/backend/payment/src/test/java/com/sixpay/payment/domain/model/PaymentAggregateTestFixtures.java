...
public final class PaymentAggregateTestFixtures {
    ...
    static Payment approvedPayment() {
        ...
        payment.recordAuthorizationDecision(
                sixpayAuthorizationApproved(T0.plusSeconds(4)),
                null,
                T0.plusSeconds(4),
                profiles
        );
    ...
    static SixpayAuthorizationDecisionSnapshot
            sixpayAuthorizationApproved(Instant decidedAt) {
        return new SixpayAuthorizationDecisionSnapshot(
                SixpayAuthorizationDecision.APPROVED,
                List.of(
                        sixpayAuthorizationCheck(SixpayAuthorizationCheck.PARTNER_AUTHORIZED, SixpayAuthorizationCheckResult.PASS),
                        sixpayAuthorizationCheck(SixpayAuthorizationCheck.SUBSCRIPTION_AUTHORIZED, SixpayAuthorizationCheckResult.PASS),
                        sixpayAuthorizationCheck(SixpayAuthorizationCheck.APPLICATION_AUTHORIZED, SixpayAuthorizationCheckResult.PASS),
                        sixpayAuthorizationCheck(SixpayAuthorizationCheck.CLAIM_TYPE_AUTHORIZED, SixpayAuthorizationCheckResult.PASS),
                        sixpayAuthorizationCheck(SixpayAuthorizationCheck.EXECUTION_DATE_VALID, SixpayAuthorizationCheckResult.PASS),
                        sixpayAuthorizationCheck(SixpayAuthorizationCheck.REQUEST_DATA_CONSISTENT, SixpayAuthorizationCheckResult.PASS)
                ),
                null,
                decidedAt
        );
    ...
    static SixpayAuthorizationDecisionSnapshot
            sixpayAuthorizationRejected(
                    SixpayAuthorizationCheck failedCheck,
                    String failureCode,
                    Instant decidedAt
            ) {
        return new SixpayAuthorizationDecisionSnapshot(
                SixpayAuthorizationDecision.REJECTED,
                List.of(
                        sixpayAuthorizationCheck(SixpayAuthorizationCheck.PARTNER_AUTHORIZED, resultFor(SixpayAuthorizationCheck.PARTNER_AUTHORIZED, failedCheck)),
                        sixpayAuthorizationCheck(SixpayAuthorizationCheck.SUBSCRIPTION_AUTHORIZED, resultFor(SixpayAuthorizationCheck.SUBSCRIPTION_AUTHORIZED, failedCheck)),
                        sixpayAuthorizationCheck(SixpayAuthorizationCheck.APPLICATION_AUTHORIZED, resultFor(SixpayAuthorizationCheck.APPLICATION_AUTHORIZED, failedCheck)),
                        sixpayAuthorizationCheck(SixpayAuthorizationCheck.CLAIM_TYPE_AUTHORIZED, resultFor(SixpayAuthorizationCheck.CLAIM_TYPE_AUTHORIZED, failedCheck)),
                        sixpayAuthorizationCheck(SixpayAuthorizationCheck.EXECUTION_DATE_VALID, resultFor(SixpayAuthorizationCheck.EXECUTION_DATE_VALID, failedCheck)),
                        sixpayAuthorizationCheck(SixpayAuthorizationCheck.REQUEST_DATA_CONSISTENT, resultFor(SixpayAuthorizationCheck.REQUEST_DATA_CONSISTENT, failedCheck))
                ),
                FailureCode.of(failureCode),
                decidedAt
        );
    }

    private static SixpayAuthorizationCheckEvidence sixpayAuthorizationCheck(
            SixpayAuthorizationCheck check,
            SixpayAuthorizationCheckResult result
    ) {
        return new SixpayAuthorizationCheckEvidence(check, result);
    }

    private static SixpayAuthorizationCheckResult resultFor(
            SixpayAuthorizationCheck candidate,
            SixpayAuthorizationCheck failed
    ) {
