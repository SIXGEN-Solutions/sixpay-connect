...
public final class PaymentState implements ValueObject {
    ...
    private final SixpayAuthorizationDecisionSnapshot authorizationDecision;
    ...
    private PaymentState(Builder builder) {
        ...
        authorizationDecision = builder.authorizationDecision;
    ...
    private void requireAuthorizationApproved() {
        if (authorizationDecision == null
            ...
            throw new IllegalArgumentException(
                    "Approved SIXPAY authorization decision is required"
            );
        }
    }
    ...
    public Optional<SixpayAuthorizationDecisionSnapshot>
        ...
        return Optional.ofNullable(authorizationDecision);
    }
    ...
    public static final class Builder {
        ...
        private SixpayAuthorizationDecisionSnapshot authorizationDecision;
        ...
        private Builder(PaymentState state) {
            ...
            status = state.status;
            authorizationDecision = state.authorizationDecision;
            bankingVerificationEvidence =
        ...
        public Builder authorizationDecision(
