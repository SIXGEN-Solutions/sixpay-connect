...
mvn -pl payment -am \
  -Dtest=PaymentPostPersistenceOrchestrationServiceTest,PaymentT0RecoveryServiceTest,AmplitudePaymentEventRecoveryAdapterTest,PaymentT0ClosureArchitectureTest,PaymentFoundationArchitectureTest \
