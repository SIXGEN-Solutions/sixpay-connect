...
FORBIDDEN_SYNTHETIC_ACCESSOR_KEYS = {
    ...
    "sixpay.payment.partner.api-key-enabled",
    "sixpay.payment.partner.mtls-required",
    "sixpay.payment.partner.oauth2-required",
    "sixpay.payment.partner.signature-enabled",
